...
export class QuestionEntryBuilder {
  ...
  public block<S>(id: string, block: Block<QuestionContainerBuilder, S>, args: S): this {
    ...
    this.namespace = `${this.namespace}.${id}`;

    const builder = new BlockedQuestionContainerBuilder(this.id, this.namespace, this.formBuilder, blockId);
  ...
  protected askWithBuilder<Q extends Questions, B extends QuestionBuilder<Q>>(id: string,
    ...
    return this.ask(new builderConstructor(id, this.namespace, this.formBuilder), callback);
  }
